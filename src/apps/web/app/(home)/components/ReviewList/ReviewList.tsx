  ...
  return (
    <section id="reviews" className={styles.ReviewList}>
      <div className="container">
        <Image className={styles.topRightIcon} src="/icons/top-right-corner.svg" alt="icon" width={225} height={225}/>
        ...
        <div className={styles.list}>
          ...
          <Image className={styles.bottomLeftIcon} src="/icons/bottom-left-corner.svg" alt="icon" width={225} height={225}/>
      </div>
    </section>
  )
}